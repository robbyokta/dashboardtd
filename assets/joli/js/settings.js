var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="http://localhost/dashboardci/assets/joli/css/theme-default.css"><img src="http://localhost/dashboardci/assets/joli/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="http://localhost/dashboardci/assets/joli/css/theme-brown.css"><img src="http://localhost/dashboardci/assets/joli/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="http://localhost/dashboardci/assets/joli/css/theme-blue.css"><img src="http://localhost/dashboardci/assets/joli/img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="http://localhost/dashboardci/assets/joli/css/theme-white.css"><img src="http://localhost/dashboardci/assets/joli/img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="http://localhost/dashboardci/assets/joli/css/theme-black.css"><img src="http://localhost/dashboardci/assets/joli/img/themes/black.jpg"/></a>'
        +'</div>'
...
function set_settings(theme_settings,option){
    ...
    /* Start Header Fixed */
    if(theme_settings.st_head_fixed == 0)
